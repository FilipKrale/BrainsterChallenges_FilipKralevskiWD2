    ...
    <div class="row">
        <div class="container">
            <div class="row py-3">
                ...
                <div>
                    <figure class="figure">
                        <img class="figure-img img-fluid" src="<?php echo e(asset('/assets/img/post-sample-image.jpg')); ?>" alt="Astronout in space">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Challenge23\resources\views/post.blade.php ENDPATH**/ ?>